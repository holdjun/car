...
uint16_t a1 = 8,a2 = 8,a3 = 5,a4 = 2,a5 = 2,a6 = 20,a7 = 10, a8 = 20,a9 = 50;
...
//			FTM_PWM_ChangeDuty(FTM1_CH0_PB0,FTMDuty_1);
			...
			if (leixin == 1) 
			{
				if (jiansuflag <= a5) FTM_PWM_ChangeDuty(FTM1_CH0_PB0,0);
