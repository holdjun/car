...
uint16_t a1 = 1,a2 = 1,EB = 35,ES = 18,ECB = 20,ECS = 8,kp1 = 20,kp2 = 10,kp3 = 10,kp4 = 10,kp5 = 10,kd1 = 0,kd2 = 0,kd3 = 0,kd4 = 0,kd5 = 0;
//a3 = 15,a4 = 115,a5 = 3,a6 = 5,a7 = 10, a8 = 20,a9 = 50;
uint16_t FTMDuty = 4896; 
uint16_t FTMDuty_1 = 1750;
...
//				UART_Send_Con();
	...
	//发车
		while(Flag == 2)
		{
			...
			if(leixin == 0)
			{
				if (jiasuflag <= a1) FTM_PWM_ChangeDuty(FTM1_CH0_PB0,5000);
				else 								 FTM_PWM_ChangeDuty(FTM1_CH0_PB0,FTMDuty_1);
			}
			if(leixin == 1) 
			{
				if(jiansuflag <= a2) FTM_PWM_ChangeDuty(FTM1_CH0_PB0,0);
