...
void CCD_HeiXian(void)
{
	...
	int8_t d_error,error,pre_error,kp,kd;
...
/***********************buxianchuli*************************************/
	...
	{
		if (CenterLast[0] <= 63) FTMDuty = 4100;
		if (CenterLast[0] >  63) FTMDuty = 5700;
	}
...
*/
	...
	FTMDuty = FTMDuty + kp * error + kd * d_error;
