...
#if(DataNum)   
#if(DataNum>=1)
#define    DefaultParValue1             Left
#define    DefaultParName1              UINT
#endif
#if(DataNum>=2)
#define    DefaultParValue2             Right
#define    DefaultParName2              UINT
#endif
#if(DataNum>=3)
#define    DefaultParValue3             Center
#define    DefaultParName3              UINT
#endif
#if(DataNum>=4)
#define    DefaultParValue4             FTMDuty
#define    DefaultParName4              UINT
#endif
#if(DataNum>=5)
#define    DefaultParValue5             FTMDuty_1
#define    DefaultParName5              UINT
#endif
#if(DataNum>=6)
#define    DefaultParValue6             FTMDuty_2
#define    DefaultParName6              UINT
#endif
#if(DataNum>=7)
#define    DefaultParValue7             Budao
#define    DefaultParName7              UINT
#endif
#if(DataNum>=8)
#define    DefaultParValue8             leixin
#define    DefaultParName8              UINT
#endif
#if(DataNum>=9)
#define    DefaultParValue9             Cross_flag
#define    DefaultParName9              UINT
#endif
#if(DataNum>=10)
#define    DefaultParValue10            Cross_flag_wan
#define    DefaultParName10             UINT
#endif
#if(DataNum>=11)
#define    DefaultParValue11            Cross_flag_time
#define    DefaultParName11             UINT
#endif
#if(DataNum>=12)
#define    DefaultParValue12            jiansuflag
#define    DefaultParName12             UINT
#endif
#if(DataNum>=13)
#define    DefaultParValue13            jiasuflag
