...
extern unsigned char AverageValue_last;
...
extern uint16_t Left_last;
extern uint16_t Right_last;
...
extern uint16_t Valuemax_flag;
extern uint16_t setValue;
