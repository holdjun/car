...
//	OLED_Write_String(2,yiwei(8,i),"EI ");
	OLED_Write_String(2,yiwei(6,i),"F1 ");
	OLED_Write_String(2,yiwei(8,i),"F2 ");
	OLED_Write_String(2,yiwei(10,i),"SD ");
...
//	OLED_Write_Num2(7,yiwei(8,i),a5);
	OLED_Write_Num4(7,yiwei(6,i),FTMDuty_1);
	OLED_Write_Num4(7,yiwei(8,i),FTMDuty_2);
	OLED_Write_String(7,yiwei(10,i),"     ");
	OLED_Write_String(9,yiwei(0,i),"    ");
	OLED_Write_String(0,yiwei(4,i),"         ");
