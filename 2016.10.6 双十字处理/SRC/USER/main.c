...
uint16_t a1 = 26,a2 = 26,a3 = 15,a4 = 90,a5 = 1,a6 = 4,a7 = 10, a8 = 20,a9 = 50;
uint16_t FTMDuty = 4890; 
...
//				UART_Send_Con();
			...
			OLED_Write_Num3(5,2,Cross_flag);
			OLED_Write_Num3(9,2,Cross_flag_wan);
	...
	//发车
		while(Flag == 2)
		{
			...
			if(leixin == 1) 
			{
				if(jiansuflag <= a6) FTM_PWM_ChangeDuty(FTM1_CH0_PB0,0);
