...
#if(DataNum)   
#if(DataNum>=1)
#define    DefaultParValue1             value
#define    DefaultParName1              UINT
#endif
#if(DataNum>=2)
#define    DefaultParValue2             pwm_steer
#define    DefaultParName2              UINT
#endif
#if(DataNum>=3)
#define    DefaultParValue3             pwm_left
#define    DefaultParName3              UINT
#endif
#if(DataNum>=4)
#define    DefaultParValue4             pwm_right
#define    DefaultParName4              UINT
#endif
#if(DataNum>=5)
#define    DefaultParValue5             flagCrossCenter
#define    DefaultParName5              UINT
#endif
#if(DataNum>=6)
#define    DefaultParValue6             valueLast2
#define    DefaultParName6              UINT
#endif
#if(DataNum>=7)
#define    DefaultParValue7             valueLast
#define    DefaultParName7              UINT
#endif
#if(DataNum>=8)
#define    DefaultParValue8             center_new
#define    DefaultParName8              UINT
#endif
#if(DataNum>=9)
#define    DefaultParValue9             dmacntl
#define    DefaultParName9              UINT
#endif
#if(DataNum>=10)
#define    DefaultParValue10            dmacntr
#define    DefaultParName10             UINT
#endif
#if(DataNum>=11)
#define    DefaultParValue11            speed_set_l
#define    DefaultParName11             UINT
#endif
#if(DataNum>=12)
#define    DefaultParValue12            speed_set_r
#define    DefaultParName12             UINT
#endif
#if(DataNum>=13)
#define    DefaultParValue13            value2
#define    DefaultParName13             UINT
#endif
#if(DataNum>=14)
#define    DefaultParValue14            flag_cross2_deal
#define    DefaultParName14             UINT
#endif
#if(DataNum>=15)
#define    DefaultParValue15            element
#define    DefaultParName15             "Acc1"
#endif
#if(DataNum>=16)
#define    DefaultParValue16            flag_into
#define    DefaultParName16             "Acc2"
#endif
#if(DataNum>=17)
#define    DefaultParValue17            endLineValue
#define    DefaultParName17             "Gyr1"
#endif
#if(DataNum>=18)
#define    DefaultParValue18            s
#define    DefaultParName18             "Gyr2"
#endif
#if(DataNum>=19)
#define    DefaultParValue19            flag_obstruct_cntR
#define    DefaultParName19             UINT
#endif
#if(DataNum>=20)
#define    DefaultParValue20            left
#define    DefaultParName20             "LeftSpd"
#endif
#if(DataNum>=21)
#define    DefaultParValue21            center
#define    DefaultParName21             "RightSpd"
#endif
#if(DataNum>=22)
#define    DefaultParValue22            right
#define    DefaultParName22             UINT
#endif
#if(DataNum>=23)
#define    DefaultParValue23            SendPara[22]
#define    DefaultParName23             UINT
#endif
#if(DataNum>=24)
#define    DefaultParValue24            SendPara[23]
#define    DefaultParName24             UINT
#endif
#if(DataNum>=25)
#define    DefaultParValue25            SendPara[24]
#define    DefaultParName25             UINT
#endif
#if(DataNum>=26)
#define    DefaultParValue26            SendPara[25]
#define    DefaultParName26             UINT
#endif
#if(DataNum>=27)
#define    DefaultParValue27            SendPara[26]
#define    DefaultParName27             UINT
#endif
#if(DataNum>=28)
#define    DefaultParValue28            SendPara[27]
#define    DefaultParName28             UINT
#endif
#if(DataNum>=29)
#define    DefaultParValue29            SendPara[28]
#define    DefaultParName29             "Gyr_X"
#endif
#if(DataNum>=30)
#define    DefaultParValue30            SendPara[29]
#define    DefaultParName30             UINT
#endif
#if(DataNum>=31)
#define    DefaultParValue31            SendPara[30]
#define    DefaultParName31             UINT
#endif
#if(DataNum>=32)
#define    DefaultParValue32            SendPara[31]
#define    DefaultParName32             UINT
#endif
#if(DataNum>=33)
#define    DefaultParValue33            SendPara[32]
#define    DefaultParName33             UINT
#endif
#if(DataNum>=34)
#define    DefaultParValue34            SendPara[33]
#define    DefaultParName34             UINT
#endif
#if(DataNum>=35)
#define    DefaultParValue35            SendPara[34]
#define    DefaultParName35             UINT
#endif
#if(DataNum>=36)
#define    DefaultParValue36            SendPara[35]
#define    DefaultParName36             UINT
#endif
#if(DataNum>=37)
#define    DefaultParValue37            SendPara[36]
#define    DefaultParName37             UINT
#endif
#if(DataNum>=38)
#define    DefaultParValue38             SendPara[37]
#define    DefaultParName38             UINT
#endif
#if(DataNum>=39)
#define    DefaultParValue39            SendPara[38]
#define    DefaultParName39             UINT
#endif
#if(DataNum>=40)
#define    DefaultParValue40            SendPara[39]
#define    DefaultParName40             UINT
#endif
#if(DataNum>=41)
#define    DefaultParValue41             SendPara[40]
#define    DefaultParName41            UINT
#endif
#if(DataNum>=42)
#define    DefaultParValue42            SendPara[41]
#define    DefaultParName42             UINT
#endif
#if(DataNum>=43)
#define    DefaultParValue43            SendPara[42]
