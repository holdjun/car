...
void Menu_Show(void)
{
	...
	OLED_Write_String(2,yiwei(0,yw),"a1  ");
	OLED_Write_String(2,yiwei(2,yw),"a2  ");
	OLED_Write_String(2,yiwei(4,yw),"a3  ");
	OLED_Write_String(2,yiwei(6,yw),"a4  ");
	OLED_Write_String(2,yiwei(8,yw),"a5  ");
	OLED_Write_String(2,yiwei(10,yw),"a6  ");
	OLED_Write_String(2,yiwei(12,yw),"a7  ");
